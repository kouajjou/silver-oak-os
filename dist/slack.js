...
// ── Public API ──────────────────────────────────────────────────────
export async function getSlackConversations(limit = 10) {
    const web = getClient();
...
export async function getSlackMessages(channelId, limit = 15) {
    const web = getClient();
    const meId = await getMyUserId();
...
export async function sendSlackMessage(channelId, text, channelName, threadTs) {
    const web = getClient();
