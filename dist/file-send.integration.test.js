...
describe('file sending: mocked Grammy context', () => {
    ...
    it('sends error message when file does not exist', async () => {
        ...
        expect(mockCtx.reply).toHaveBeenCalledWith('Could not send file: /tmp/nonexistent-file-abc123.pdf (not found)');
...
//# sourceMappingURL=file-send.integration.test.js.map